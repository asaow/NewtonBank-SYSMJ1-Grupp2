...
//	}
	...
	public void testremoveCustomer() {
		...
		// test retur värde som innehåller 2 strämg
		...
		// test retur värde som innehåller 4 strämg
...
//System.out.println(_banklogic.getCustomerByPNr(pNr).getAccounts().get(0).getId());
	...
	public void testdeposit() {
		...
		// Test ett lycka insättning
		Assert.assertTrue(_banklogic.deposit(pNr, 1001, 10));

		// Test misslycka insättning
